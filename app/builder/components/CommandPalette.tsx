...
export function ComponentPanel() {
  ...
  const handleInsert = (component: BuilderComponent) => {
    ...
    if (!page) return
        page.components.push({ ...component, id: `${page.id}-${component.id}-${/* ⚠️ HYDRATION FIX → useState<number|null>(null) + useEffect */}` })
        addComponent({ ...component, id: `${page.id}-${component.id}-${/* ⚠️ HYDRATION FIX → useState<number|null>(null) + useEffect */}` })
  }
