...
wss.on("connection", (ws) => {
  ...
  ws.on("message", (message) => {
    ...
    try {
      ...
      // console.error("Invalid JSON:", message.toString())  // TODO: remove before release
      return
    }
...
// console.log("WebSocket server running on ws://localhost:3001")  // TODO: remove before release
