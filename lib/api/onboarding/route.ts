...
export async function POST(req: Request) {
  try {
    ...
    try {
      ...
      // console.error("GitHub repo creation failed:", err.message);  // TODO: remove before release
    }
    ...
    try {
      ...
      // console.log("✅ Vercel deployment triggered:", vercelData.url);  // TODO: remove before release
    } catch (err: unknown) {
